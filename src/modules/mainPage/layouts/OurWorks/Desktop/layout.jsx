...
import arrow from 'img/mainPage/OurWorks/arrow.svg'
import elipse from 'img/mainPage/OurWorks/elipse.svg'
            ...
            <div className={style.wrapper}>
                ...
                <div className={style.row}>
                    ...
                    <div className={style.column}>
                        ...
                        <span>
                            {OUR_WORKS.work[1].description}
                        </span>
                    </div><div className={style.column}>
